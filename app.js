...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var messagemultiply = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplythree + '.';
  console.log(messagemultiply);
  return[sumofthree, multiplythree, messagesum, messagemultiply];
}
...
function sumArray(sumArr) { //eslint-disable-line
  var threearraysum = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0];
  var message = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + threearraysum + ' is their sum.';
  console.log(threearraysum, message);
  return[threearraysum, message];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var threearraymult = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
  var message = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + threearraymult + '.';
  console.log(threearraymult, message);
  return[threearraymult, message];
}
